...
какой режим работы выбрать. `Enter` - подтверждать каждую ссылку, `Tab` -
полуавтоматический режим, `Space` - полностью автоматический режим.
Полуавтоматический режим означает: LiVerse показывает надёжные ссылки сразу,
а сомнительные отправляет оператору на подтверждение. Если выбрано
подтверждение или полуавтомат, второй вопрос выбирает интерфейс: `Enter` -
web-пульт, `Space` - всплывающее окно.
